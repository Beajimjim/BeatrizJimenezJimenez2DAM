...
window.onload = function() {
    ...
    document.querySelector("#usuario_login").onclick = function() {
        ...
        // y se almacenan en el objeto 'datos_login'.
        ...
        let mensaje = {"usuario":usuario,"password":password}
        fetch("../servidor/?o=buscar&tabla=usuarios", {
            ...
            .then(response => {
            return response.text();                        // Convierte la respuesta del servidor en un objeto JSON.
            })
            .then(datosRespuestaFetch => { // Maneja la respuesta del servidor.
                ...
                if (datosRespuestaFetch.length > 0) { // En el caso de que el login sea satisfactorio
                    ...
                    localStorage.setItem('appsge_usuario', datosRespuestaFetch[0].usuario);
