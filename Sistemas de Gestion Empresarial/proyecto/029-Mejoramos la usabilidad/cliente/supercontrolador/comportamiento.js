...
function cargaDatosTabla(tabla) {
    ...
    fetch("../../servidor/columnas_tabla.php?tabla=" + tabla)
        ...
        .then(datos => {
            ...
            contiene_modal.innerHTML = "<h1>Formulario de inserción</h1>"                                                           // Si el modal contenía algo, lo vaćio
            ...
            columnas_tabla.forEach(function(columna){                                               // PAra cada una de las columnas de la tabla
                ...
                let campo = document.createElement("input")                                         // Creo un campo input
                campo.setAttribute("placeholder",columna)                                           // Le pongo una leyenda al campo
                contenedor.appendChild(campo)                                                    // Lo añado al modal
