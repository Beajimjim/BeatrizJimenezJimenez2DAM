        ...
        .then(datos => {
            ...
            boton_enviar.onclick = function () {
                ...
                coleccioncampos.forEach(function (campo) {
                    ...
                    console.log('datos formulario:', campo.files, 'valor:',campo.value )
                });
...
function actualizarNombreTabla(nombreTabla) {
    // Selecciona el elemento <h5> por su id
    const tituloTabla = document.getElementById("nombre-tabla");

    // Actualiza el texto del <h5> con el nombre de la tabla proporcionado
    tituloTabla.textContent = nombreTabla;
}
